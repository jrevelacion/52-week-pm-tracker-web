      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            className="bg-primary hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg flex items-center gap-2 transition-colors"
          >
            <Plus size={20} />
            Add Activity
          </button>
        ...
        <div className="bg-white rounded-lg p-4 mb-8 shadow-md">
          <div className="flex items-center justify-between">
            <button
              ...
              className="px-4 py-2 hover:bg-surface rounded-lg transition-colors"
            >
              ← Previous Week
            </button>
